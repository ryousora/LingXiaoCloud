...
public class TokenInterceptor implements HandlerInterceptor {
    ...
    /** 受保护资源的根路径 */
    private static final String API_V1_URI_ROOT = "/user/";
    ...
    public boolean preHandle(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, Object o) throws Exception {
        ...
        return true;*/
        String token = null;
        if ((token = httpServletRequest.getParameter("token")) == null) {
        ...
        if (!httpServletRequest.getRequestURI().matches(API_V1_URI_ROOT + username + ".*")) {

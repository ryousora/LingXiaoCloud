...
public class FolderController {
     ...
     */
    @RequestMapping(value = "/user/{username}/{menu}", method = RequestMethod.GET)
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/user/{username}/disk/folders/{folderId}", method = RequestMethod.GET)
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/user/{username}/disk/search", method = RequestMethod.GET)
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/user/{username}/disk/move", method = RequestMethod.PATCH)
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/user/{username}/disk/folders/{folderId}", method = RequestMethod.PATCH)
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/user/{username}/disk/files/{fileId}", method = RequestMethod.PATCH)
    @ResponseBody
     ...
     */
    @RequestMapping(value = "/user/{username}/disk/folders", method = RequestMethod.POST)
    @ResponseBody
    public UserFolderDTO newFolder(@PathVariable String username, @RequestBody @Valid UserFolder reqBody) {
        // TODO 参数校验
        int userId = userService.getUserByUsername(username).getUserId();
        reqBody.setUserId(userId);
        if(diskService.isFolderExist(reqBody.getUserId(),reqBody.getParentId(),reqBody.getFolderName())){
            return new UserFolderDTO(-1);
        }
     ...
     */
    @RequestMapping(value = "/user/{username}/recycle", method = RequestMethod.DELETE)
    @ResponseBody
